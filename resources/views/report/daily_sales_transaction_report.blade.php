<html>
<head>
<title>Daily Sales Transaction Report</title>
<!-- Google Tag Manager -->
  ...
  <div class="main" style="">
    <table class="detail" style="width:100%;margin-top:30px;border-collapse: collapse;margin-bottom:20px;">
        <thead>
          ...
          <td align="center" style="width: 10%;">Payment Amount</td>
          <td align="center" style="width: 10%;">Balance</td>
        ...
        <tbody>
          @foreach($transaction as $index => $result)
            <tr>
              ...
              <td align="right">Rm {{number_format($result->payment,2)}}</td>
              <td align="right">Rm {{number_format($result->balance,2)}}</td>
          ...
          <tr>
            ...
            <td align="right" style="font-weight:bold;">Rm {{number_format($transaction->sum('payment'),2)}}</td>
            <td align="right" style="font-weight:bold;">Rm {{number_format($transaction->sum('balance'),2)}}</td>
