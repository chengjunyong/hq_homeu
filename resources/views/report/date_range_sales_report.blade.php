@extends('layouts.app')
<title>Date Range Sales Transaction Report</title>
@section('content')
...
<form method="post" action="{{route('postDateRangeSalesReport')}}" target="_blank">
  @csrf
  <h2 align="center">Date Range Sales Transaction Report</h2>
  <div class="container">
    <div class="card">
      <div class="card-body">
        <div class="row">
...
<script>
  $(document).ready(function(){
    $("#export_report").click(function(){
      ...
      $.get("{{route('ajaxDateRangeSalesReport')}}",
      {
        'branch_id' : branch_id,
        'start' : start,
        'end' : end,
