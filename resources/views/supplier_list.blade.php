      ...
      <table id="history" style="width:100%">
         ...
         <tbody>
          ...
          <tr>
            ...
            <td><buttton class="btn btn-danger delete" id='{{$result->id}}'>Delete</buttton></td>
          </tr>
          @endforeach
        </tbody>
      </table>
...
$(document).ready(function(){
  ...
  $(".delete").click(function(){
    ...
    swal.fire({
      ...
      html:'Are you sure to delete this supplier. This action is irreversible',
      icon:'warning',
      ...
      if(res.isConfirmed){
        $.get('{{route('deleteSupplier')}}',
        {
          'id':id,
        },function(data){
          if(data){
            swal.fire('Success','Supplier Deleted Successful','success');
            $(`#${id}`).parent().parent().remove();
          }else{
            swal.fire('Error','Supplier Deleted Unsuccessful, Please Try Again','error');
          }
        },'json');
      }
    });
